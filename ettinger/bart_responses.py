    ...
    for testname in testlist:
        ...
        with open(os.path.join(args.data_dir,testname+'-contextlist')) as cont:
            for line in cont:
                ...
                mask_line = line.strip()[:-7] + f" {tokenizer.mask_token}"
                inputlist.append(mask_line)
        ...
        print("2 check")
        top_preds, top_probs, tgt_probs = get_model_responses(inputlist, tgtlist, args.model_name_or_path, model, tokenizer, bert=True, k=k)
